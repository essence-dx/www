/**
 * dx-browser-host.js - JavaScript host functions for the dx-www browser runtime.
 * 
...
/**
 * DxBrowserHost - Host function provider for browser WASM.
 */
export class DxBrowserHost {
    constructor() {
     ...
     */
    host_log(val) {
        console.log('[dx-www-browser]', val);
    }
