//! # dx-www-browser: Sub-20KB Browser WASM Runtime (Pure FFI)
//!
//! Full-featured Macro runtime without wasm-bindgen bloat.
//! Uses pure FFI imports like dx-www-browser-micro but with complete HTIP support.
//!
//! ## Features
...
#[cfg(not(target_arch = "wasm32"))]
unsafe fn host_clone_template(_id: u32) -> u32 { 0 }
#[cfg(not(target_arch = "wasm32"))]
unsafe fn host_cache_template(_id: u32, _html_ptr: *const u8, _html_len: u32) {}
#[cfg(not(target_arch = "wasm32"))]
unsafe fn host_append(_parent: u32, _child: u32) {}
#[cfg(not(target_arch = "wasm32"))]
unsafe fn host_remove(_node: u32) {}
#[cfg(not(target_arch = "wasm32"))]
unsafe fn host_set_text(_node: u32, _ptr: *const u8, _len: u32) {}
#[cfg(not(target_arch = "wasm32"))]
unsafe fn host_set_attr(_node: u32, _key_ptr: *const u8, _key_len: u32, _val_ptr: *const u8, _val_len: u32) {}
#[cfg(not(target_arch = "wasm32"))]
unsafe fn host_toggle_class(_node: u32, _class_ptr: *const u8, _class_len: u32, _enable: u32) {}
#[cfg(not(target_arch = "wasm32"))]
unsafe fn host_listen(_node: u32, _event_type: u32, _handler_id: u32) {}
#[cfg(not(target_arch = "wasm32"))]
#[allow(dead_code)]
unsafe fn host_notify_state_change(_slot_id: u32) {}
#[cfg(not(target_arch = "wasm32"))]
unsafe fn host_get_cached_base(_cache_id: u32, _buf_ptr: *mut u8, _buf_len: u32) -> u32 { 0 }
#[cfg(not(target_arch = "wasm32"))]
unsafe fn host_store_patched(_cache_id: u32, _data_ptr: *const u8, _data_len: u32) {}
#[cfg(not(target_arch = "wasm32"))]
unsafe fn host_log(_val: u32) {}
