...
impl WasmCompiler {
    ...
    fn detect_toolchains(&mut self) {
        self.detected
            .insert(SourceLanguage::Rust, Self::check_command("rustc"));
        self.detected
            .insert(SourceLanguage::Python, Self::check_command("python3"));
        ...
        self.detected
            .insert(SourceLanguage::Go, Self::check_command("tinygo"));
    }
