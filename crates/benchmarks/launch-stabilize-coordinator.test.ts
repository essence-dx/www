...
test("Lane 14 launch coordinator classifies current launch handoff dirty files", () => {
  const report = buildLaunchCoordinatorReport({
    ...
    gitStatusText: [
      ...
      " M integrations/n8n-nodes-base/dx-node-source-manifest.json",
...
test("Lane 14 launch coordinator classifies conversion proof static parity outputs", () => {
  const report = buildLaunchCoordinatorReport({
    ...
    gitStatusText: [
      ...
      " M examples/conversion-proof/.dx/vercel-landing/preview-manifest.json",
      ...
      " M examples/conversion-proof/public/preview-manifest.json",
      " M benchmarks/dx-www-conversion-proof.test.ts",
      " M examples/conversion-proof/.dx/forge/source-manifest.json",
