//! # Codegen Module - Legacy HTIP Generator
//!
//! Instead of generating Rust code and compiling to WASM (418KB overhead),
//! this module directly emits legacy HTIP opcodes that the dx-www browser runtime
...
//!
//! The dx-www browser WASM runtime is the shared WASM. Apps are pure data.
...
mod tests {
    ...
    fn test_htip_generation() {
        ...
        assert!(
            stream.len() < 500,
            "HTIP stream should be tiny, got {} bytes",
            stream.len()
        );
    }
}
