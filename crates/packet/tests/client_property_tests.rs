//! Property-based tests for the DX WWW browser HTIP protocol
//!
//! These tests verify the correctness of HTIP rendering, event dispatch,
//! and incremental updates using property-based testing.
//!
//! Tests are in the packet crate because the browser runtime crate is no_std.
...
// ============================================================================
// HTIP Opcode Constants (must match browser/src/lib.rs)
// ============================================================================
