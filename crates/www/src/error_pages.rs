...
type ErrorPageResult<T> = Result<T, Box<DxError>>;
...
impl ErrorPageRegistry {
    ...
    ///
    /// Looks for:
    /// - `_error.html` - Default error page
    /// - `_404.html` - Custom 404 page
    /// - `_500.html` - Custom 500 page
    pub fn scan(&mut self, pages_dir: &Path) -> ErrorPageResult<()> {
        // Check for _error.html (default error page)
        let error_path = pages_dir.join("_error.html");
        ...
        // Check for _404.html
        let not_found_path = pages_dir.join("_404.html");
        ...
        // Check for _500.html
        let server_error_path = pages_dir.join("_500.html");
    ...
    pub fn load(&mut self, status_code: u16) -> ErrorPageResult<Option<&ParsedComponent>> {
...
mod tests {
    ...
    fn test_error_page_registry_register() {
        ...
        registry.register(404, PathBuf::from("_404.html"));
