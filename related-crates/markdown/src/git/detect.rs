...
mod tests {
    ...
    fn test_detect_binary() {
        assert_eq!(
            detect_format(b"DXMB\x00\x01\x00\x00"),
    ...
    fn test_detect_markdown_link() {
        assert_eq!(
            detect_format(b"See [docs](https://example.com)"),
            DetectedFormat::Markdown
        );
    }
    ...
    fn test_detect_markdown_bold() {
        assert_eq!(
            detect_format(b"This is **bold** text"),
            DetectedFormat::Markdown
        );
    }
    ...
    fn test_detect_markdown_blockquote() {
        assert_eq!(
            detect_format(b"> This is a quote"),
            DetectedFormat::Markdown
        );
    }
