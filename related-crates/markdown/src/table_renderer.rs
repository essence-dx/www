...
mod tests {
    ...
    fn test_numeric_right_alignment() {
        ...
        assert_eq!(
            renderer.get_cell_alignment(&int_cell, None),
            Alignment::Right
        );
        assert_eq!(
            renderer.get_cell_alignment(&float_cell, None),
            Alignment::Right
        );
        assert_eq!(
            renderer.get_cell_alignment(&text_cell, None),
            Alignment::Left
        );
    }
    ...
    fn test_type_hint_alignment() {
        ...
        assert_eq!(
            renderer.get_cell_alignment(&cell, Some(&col_int)),
            Alignment::Right
        );
        assert_eq!(
            renderer.get_cell_alignment(&cell, Some(&col_str)),
            Alignment::Left
        );
    }
