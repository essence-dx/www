...
mod tests {
    ...
    fn test_output_format_parse() {
        ...
        assert_eq!(OutputFormat::parse("sr"), Some(OutputFormat::Binary));
        ...
        assert_eq!(
            OutputFormat::parse("terminal"),
            Some(OutputFormat::Terminal)
        );
        assert_eq!(OutputFormat::parse("term"), Some(OutputFormat::Terminal));
