...
pub enum SafetyError {
    ...
    BoundsCheck {
        /// Starting byte offset requested by the caller.
        offset: usize,
        /// Number of bytes requested from the offset.
        size: usize,
        /// Total length of the validated buffer.
        buffer_len: usize,
    },
    ...
    AlignmentCheck {
        /// Pointer address that failed the alignment check.
        address: usize,
