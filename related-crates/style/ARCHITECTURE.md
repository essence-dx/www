...
This document describes the architecture of the `dx-style` crate, the DX style
engine for generated CSS, utility parsing, grouping analysis, serializer-backed
receipts, and optional Binary Dawn experiments.

## Overview

dx-style is a high-performance CSS generation engine that transforms utility
class names into CSS rules. It features incremental parsing, auto-grouping for
class deduplication, a normal generated CSS output path, optional Binary Dawn
artifacts for measured experiments, and a pipeline architecture for testable,
maintainable code.
...
## Optional Binary Dawn Format

Binary Dawn is an optional sidecar format for measured experiments and internal
style cache work. Generated CSS remains the default browser-facing style output
for WWW projects.
