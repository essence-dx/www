...
// Public receipt APIs are consumed by dx-check/Zed surfaces even when dx-style
// does not call every exported symbol internally.
#[allow(unused_imports)]
pub use engine::StyleEngine;
#[allow(unused_imports)]
pub use engine::browser_compat::{
    TAILWIND_POSTCSS_BROWSER_COMPAT_BASELINE, TAILWIND_POSTCSS_BROWSER_COMPAT_CLASSES,
    TAILWIND_POSTCSS_BROWSER_COMPAT_COMPARISON_SCOPE, TAILWIND_POSTCSS_BROWSER_COMPAT_FIXTURE_PATH,
    TAILWIND_POSTCSS_BROWSER_COMPAT_SCHEMA, TAILWIND_POSTCSS_BROWSER_COMPAT_SELECTOR_CLASSES,
    TAILWIND_POSTCSS_BROWSER_COMPAT_SELECTOR_COMPARISON_SCOPE,
    TailwindPostcssBrowserCompatContract, tailwind_postcss_browser_compat_contract,
};
#[allow(unused_imports)]
pub use engine::directive_ledger::{
    TAILWIND_V43_CSS_DIRECTIVE_LEDGER_BASELINE, TAILWIND_V43_CSS_DIRECTIVE_LEDGER_SCHEMA,
    TAILWIND_V43_CSS_DIRECTIVE_LEDGER_SCOPE, TailwindV43CssDirectiveLedgerEntry,
    tailwind_v43_css_directive_ledger,
};
#[allow(unused_imports)]
pub use engine::equal_output::{
    TAILWIND_EQUAL_OUTPUT_CANARY_BASELINE, TAILWIND_EQUAL_OUTPUT_CANARY_COMPARISON_SCOPE,
    TAILWIND_EQUAL_OUTPUT_CANARY_FIXTURE_PATH, TAILWIND_EQUAL_OUTPUT_CANARY_SCHEMA,
    TailwindEqualOutputCanaryContract, TailwindEqualOutputCanaryEntry,
    TailwindEqualOutputCanaryFixture, tailwind_equal_output_canary_contract,
};
#[allow(unused_imports)]
pub use engine::feature_matrix::{
    TAILWIND_V43_FEATURE_MATRIX_BASELINE, TAILWIND_V43_FEATURE_MATRIX_SCOPE,
    TailwindV43FeatureMatrixEntry, TailwindV43FeatureStatus, tailwind_v43_feature_matrix,
};
#[allow(unused_imports)]
pub use engine::parity::{
    TAILWIND_PARITY_BASELINE, TAILWIND_PARITY_RECEIPT_SCHEMA, TAILWIND_PARITY_SCOPE,
    TailwindParityEntry, TailwindParityFixture, TailwindParityReceipt, TailwindParityStatus,
    build_tailwind_parity_receipt, tailwind_parity_fixtures, tailwind_parity_receipt_json,
};
#[allow(unused_imports)]
pub use engine::postcss_compat::{
    CssImportSource, DxStyleBrowserTarget, POSTCSS_COMPAT_MATRIX_FIXTURE_PATH,
    POSTCSS_COMPAT_MATRIX_SCHEMA, POSTCSS_COMPAT_RECEIPT_SCHEMA, PostcssCompatMatrixEntry,
    PostcssCompatOptions, PostcssCompatOutput, PostcssCompatReceipt, PostcssCompatStatus,
    PostcssCompatibilityContract, PostcssSourceMapMapping, PostcssSourceMapReceipt,
    PostcssSourceOrigin, postcss_compat_matrix, postcss_compatibility_contract,
    transform_postcss_compatible_css,
};
#[allow(unused_imports)]
pub use engine::theme_css::{
    CssCustomVariant, CssDirectiveDiagnostic, CssReferenceDirective, CssSourceDirective,
    CssSourceScanPlan, CssUtilityDefinition, css_first_directive_diagnostics,
    ...
    theme_layer_css_from_source,
};
#[allow(unused_imports)]
pub use engine::utility_ledger::{
    TAILWIND_V43_UTILITY_LEDGER_BASELINE, TAILWIND_V43_UTILITY_LEDGER_SCHEMA,
    TAILWIND_V43_UTILITY_LEDGER_SCOPE, TailwindV43UtilityLedgerEntry, tailwind_v43_utility_ledger,
};
...
/// Generate CSS for one utility class using the shared dx-style engine.
pub fn css_for_class(class_name: &str) -> Option<String> {
    AppState::engine().css_for_class(class_name)
}

/// Parse and reprint generated CSS through dx-style's Lightning CSS formatter.
...
pub fn rebuild_styles(
    ...
    let (css_write_duration, write_stats) = {
        ...
        if need_full {
            ...
            state_guard
                .css_buffer
                .extend_from_slice(b"@layer components {}\n");
            ...
            if let Some(layer_pos) = twoway::find_bytes(
                &state_guard.css_buffer[utilities_start..],
                b"@layer utilities",
            ) {
                let abs_layer_pos = utilities_start + layer_pos;
                if let Some(rel_brace) = state_guard.css_buffer[abs_layer_pos..]
                    .iter()
                    .position(|b| *b == b'{')
                {
