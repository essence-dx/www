...
//!
//! Provides ASCII art header rendering for the dx-style CLI using FIGlet-style fonts.
//! Supports terminal width detection and text alignment.
...
impl DXCliFont {
    ...
    pub fn default() -> Result<Self, FontError> {
        // The standard.dx font is embedded for CLI header rendering
