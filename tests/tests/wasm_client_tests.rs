...
//!
//! Comprehensive tests for the dx-www browser WASM runtime including:
...
mod opcode_tests {
    ...
    fn test_op_patch_attr_handler() {
        ...
        let stream = HtipBuilder::new()
            .patch_attr(10, b"class", b"active")
            .eof()
            .build();
    ...
    fn test_op_class_toggle_disable() {
        ...
        let stream = HtipBuilder::new()
            .class_toggle(5, b"visible", false)
            .eof()
            .build();
